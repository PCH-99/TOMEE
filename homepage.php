	...
	<div class="container mt-5 pt-1 pb-1 userpage_container">
		...
		<main>
			...
			<article>
				...
				<div class="col-11 mx-auto mt-2 mt-md-4 p-2 m-1 h4 text-center"> Najpopularniejsze konta </div>
...
<?php	
				...
				{				
					...
					{
					    echo '<div class="mx-auto col-12 col-sm-11 col-md-10 col-lg-8 text-center top-face">';
						for($i=1;$i<=4;$i++)
						{
...
else
{
	...
	echo '<div class="col-12 mx-auto mt-2 mt-md-4 p-2 m-1 h4 text-center"> Ostatnie wpisy znajomych </div>';
