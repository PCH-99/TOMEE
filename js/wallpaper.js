...
function wallp()
{
	document.getElementById("wp1").style.background = "linear-gradient(to top,"+randColr()+", white)";
	
	$('#wp2').css('opacity','0');

	setTimeout(function() { document.getElementById("wp2").style.background = "linear-gradient(to top, "+randColr()+", white)"; },3100);
