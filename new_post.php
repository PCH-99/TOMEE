		...
		<main>
			...
			<article>
				...
				<div class="row">
					...
					<div class="col-10 col-md-9 col-lg-7 formularz_log mx-auto mt-3 px-2 text-center">
					
						<div class="mx-auto my-1 text-center">Utwórz post:</div>
						
						<div class="mx-auto my-3 text-center">
						
							<form action="add_post.php" method="post">
							
								<textarea class="new_post" placeholder="Napisz coś, z czym chesz się podzielić" name="post"></textarea>
								
								<input class="col-10 col-sm-7 col-md-6 col-lg-4 mb-4" type="submit" value="Opublikuj post"/>
...
{
	echo "<div class='navb mb-3 px-4 text-danger'>Nie opublikowano posta, ponieważ ".$_SESSION['error_post']."</div>";
