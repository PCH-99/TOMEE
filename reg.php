	...
	<div class="container">
		...
		<header><div class="row">
			...
			<div class="col-12 mx-auto mb-3 p-1">
				...
				<div class="float-right px-2 navb mr-3 text-light">
				    <i class="icofont-email"></i>
				    <a class="text-light" href="pomoc" target="_blank">Kontakt</a></div>
			</div>
		...
		<main>
			...
			<article><div class="row">
				...
				<div class="col-9 col-lg-7 formularz_log mx-auto text-center log log1">
						...
						<div class="mb-3 h2">Panel logowania</div>
						...
						<div class="formularz_log mx-auto text-center reg reg1">
							...
							<div class="mb-3 h2">Załóż konto na Tomee</div>
		...
		<footer>
			...
			<div class="row">
				...
				<div class="col-10 col-sm-8 col-md-6 col-lg-5 footer footer1">&#9400; PCH_99 2020 - 2022 <br /><a href="regulamin-serwisu" target="_blank"> Regulamin portalu</a> - <a href="polityka-prywatnosci" target="_blank">Polityka prywatności</a></div>
